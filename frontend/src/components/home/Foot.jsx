      ...
      <div className={classes.upper}>
        <div className={classes.left}>
          <div className={classes.spanlogo}>
              <NavLink to="https://www.google.com/maps/place/Walchand+College+of+Engineering/@16.8457387,74.5988826,17z/data=!3m1!4b1!4m6!3m5!1s0x3bc1237f52c65db5:0xa3535676176ded0a!8m2!3d16.8457387!4d74.6014575!16zL20vMDVoZG5q?entry=ttu">
        ...
        <div className={classes.middle}>
          ...
          <div className={classes.profiles}>
            <Tippy placement="bottom" content="Instagram" delay="200">
              <NavLink to="https://www.instagram.com/wce_sait/">
                <BsInstagram size={25} color="black" />
              </NavLink>
            </Tippy>
            <Tippy placement="bottom" content="WhatsApp" delay="200">
              <NavLink to="https://api.whatsapp.com/send?phone=919168171111&text=Hello,%20I%20have%20a%20doubt%20regarding%20techfusion%202.0">
                <BsWhatsapp size={25} color="black" />
              </NavLink>
            </Tippy>
            <Tippy placement="bottom" content="LinkedIn" delay="200">
              <NavLink to="https://www.linkedin.com/company/wcesait/mycompany/">
                <FaLinkedinIn size={25} color="black" />
              </NavLink>
            </Tippy>
            <Tippy placement="bottom" content="Mail" delay="200">
              <NavLink to="mailto:wce.sait@walchandsangli.ac.in">

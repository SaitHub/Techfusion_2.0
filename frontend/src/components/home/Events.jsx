...
const Events = () => {
  ...
  const eventsdata = [
    ...
    },
    {
      ...
      title: "NetVerse",
      content:
        "NetVerse, a day-long event exploring computer networks. Learn the basics, understand IP addresses, and explore real-world applications. Get hands-on experience and practical skills. It's a fun and easy way to dive into the world of networks!",
    },
    {
      id: 4,
      image: b2b,
